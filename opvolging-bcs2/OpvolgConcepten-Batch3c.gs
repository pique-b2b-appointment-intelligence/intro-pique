 ...
 *  2. Importeer Opvolging-Batch3c-Data.csv in dat tabblad (kopregel op rij 1).
...
function zetConceptenKlaar() {
  ...
  const isGeneriek = e => /^(info|klantenservice|klantcontact|hello|hallo|contact|support|sales|office|welcome|post|service|help|shop|webshop|mail|klantenservice)@/i.test(e);
