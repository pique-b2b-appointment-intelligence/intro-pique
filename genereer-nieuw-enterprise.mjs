...
import { PROSPECTS } from './pique-nieuw-enterprise-data.mjs';
...
function render(p){
  ...
  const C = [
    ...
    { side:'center', header:true, eyebrow:'Wat ik doe', kop:'Pique, in het kort.', sub:`Ik open gesprekken met de beslissers bij je droomaccounts die je normaal niet warm te pakken krijgt. Diepgaande research per account, op naam en met een reden. Soms met iets tastbaars, zoals ${esc(objLower)}.` },
    { side:'right', num:'01', kop:'Eén sprint, 25 droomaccounts', body:`Jij kiest de accounts die er strategisch toe doen. Ik open ze in acht weken, op naam en met een reden die per account klopt.` },
    { side:'left', num:'02', kop:'Volledig voor jou', body:`Wat ik voor ${org} open, is van ${org}. Nooit gedeeld, nooit doorverkocht.` },
    { side:'right', num:'03', kop:'Bewijs een handvol, dan opschalen', body:`We beginnen met een korte lijst accounts. Werkt het, dan breiden we de lijst uit.` },
  ];
...
<meta name="description" content="Een persoonlijk voorstel voor ${org}. Account-based, op je droomaccounts, exclusief voor jou.">
...
/* REVIEWS */
.reviews{background:var(--navy);color:#fff;padding:clamp(4.5rem,9vh,7rem) clamp(1.5rem,4vw,2rem)}.rv-eyebrow{text-align:center;font-size:.7rem;font-weight:600;letter-spacing:.2em;text-transform:uppercase;color:var(--ambers);margin-bottom:.9rem}.rv-rating{display:flex;align-items:center;justify-content:center;gap:.5rem;margin-bottom:2.75rem}.rv-rating .rv-rs{color:var(--amber);font-size:.85rem;letter-spacing:.12em}.rv-rating span:last-child{font-size:.72rem;color:rgba(255,255,255,.4);letter-spacing:.03em}.rv-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;max-width:1120px;margin:0 auto}.rv{background:rgba(255,255,255,.038);border:1px solid rgba(255,255,255,.072);border-top:2px solid rgba(224,172,102,.38);border-radius:20px;padding:2.4rem 2.1rem 1.9rem;display:flex;flex-direction:column;position:relative;overflow:hidden;transition:background .25s,border-top-color .25s,transform .25s}.rv:hover{background:rgba(255,255,255,.058);border-top-color:var(--amber);transform:translateY(-4px)}.rv-deco{position:absolute;bottom:-2.5rem;right:1.1rem;font-family:var(--serif);font-size:11rem;line-height:1;color:rgba(224,172,102,.06);pointer-events:none;user-select:none;z-index:0}.rv-gmark{position:absolute;top:1.3rem;right:1.4rem;width:19px;height:19px;opacity:.9;z-index:2}.rv-stars{display:flex;gap:.2rem;margin-bottom:1.2rem;color:var(--amber);font-size:.85rem;letter-spacing:.1em;position:relative;z-index:1}.rv-q{font-family:var(--serif);font-weight:500;font-size:1.16rem;line-height:1.7;color:rgba(255,255,255,.88);letter-spacing:-.01em;flex:1;position:relative;z-index:1}.rv-foot{display:flex;align-items:center;gap:.85rem;margin-top:1.7rem;padding-top:1.2rem;border-top:1px solid rgba(255,255,255,.08);position:relative;z-index:1}.rv-avatar{width:46px;height:46px;border-radius:50%;object-fit:cover;flex-shrink:0;border:2px solid rgba(224,172,102,.5);box-shadow:0 4px 16px rgba(0,0,0,.3)}.rv-meta{display:flex;flex-direction:column;gap:2px;min-width:0}.rv-name{font-size:.84rem;font-weight:600;color:rgba(255,255,255,.88);letter-spacing:.02em}.rv-company{font-size:.72rem;color:rgba(255,255,255,.42);letter-spacing:.02em}
@media(max-width:820px){.rv-grid{grid-template-columns:1fr;max-width:460px}}
...
.gr-star{color:var(--amber);font-weight:700}.gr-cta-btn{display:inline-flex;align-items:center;gap:.5rem;margin-top:1.6rem;background:var(--amber);color:#fff;text-decoration:none;font-weight:600;font-size:1rem;padding:.9rem 1.7rem;border-radius:100px;transition:gap .3s var(--ease),background .3s,transform .3s}.gr-cta-btn:hover{gap:.85rem;background:#b47a30;transform:translateY(-2px)}.gr-cta-btn svg{width:16px;height:16px;stroke:#fff;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
/* FOOTER */
...
<section class="guarantee" id="gesprek-cta">
  <div class="gr-card reveal" style="text-align:center">
    <div class="gr-eyebrow">De volgende stap</div>
    <p class="gr-head">Even vrijblijvend kennismaken?</p>
    <p class="gr-text">Dit is geen verkoopgesprek. We kijken samen of dit bij ${org} past, en of dat koude stuk warmer kan.</p>
    <a class="gr-cta-btn" href="${CAL}" target="_blank" rel="noopener">Plan een gesprek <svg viewBox="0 0 24 24"><path d="M5 12h14M13 6l6 6-6 6"/></svg></a>
  </div>
</section>
...
<section class="reviews">
  ...
  <div class="rv-rating reveal"><span class="rv-rs">&#9733;&#9733;&#9733;&#9733;&#9733;</span><span>5,0 gemiddeld op Google</span></div>
  <div class="rv-grid">
    <figure class="rv reveal"><div class="rv-deco">&ldquo;</div><svg class="rv-gmark" viewBox="0 0 24 24" aria-label="Google review"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.76h3.56c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.56-2.76c-.98.66-2.23 1.06-3.72 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84A11 11 0 0 0 12 23z"/><path fill="#FBBC05" d="M5.84 14.11a6.6 6.6 0 0 1 0-4.22V7.05H2.18a11 11 0 0 0 0 9.9l3.66-2.84z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.05l3.66 2.84C6.71 7.31 9.14 5.38 12 5.38z"/></svg><div class="rv-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><blockquote class="rv-q">&ldquo;Had oprecht niet gedacht dat de service zo uitgebreid was. De strategie vind ik persoonlijk geweldig.&rdquo;</blockquote><figcaption class="rv-foot"><img class="rv-avatar" src="review-david.png" alt="David" loading="lazy" style="object-position:50% 18%"><span class="rv-meta"><span class="rv-name">David</span><span class="rv-company">Azora Studio</span></span></figcaption></figure>
    <figure class="rv reveal"><div class="rv-deco">&ldquo;</div><svg class="rv-gmark" viewBox="0 0 24 24" aria-label="Google review"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.76h3.56c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.56-2.76c-.98.66-2.23 1.06-3.72 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84A11 11 0 0 0 12 23z"/><path fill="#FBBC05" d="M5.84 14.11a6.6 6.6 0 0 1 0-4.22V7.05H2.18a11 11 0 0 0 0 9.9l3.66-2.84z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.05l3.66 2.84C6.71 7.31 9.14 5.38 12 5.38z"/></svg><div class="rv-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><blockquote class="rv-q">&ldquo;Professioneel, afspraken nagekomen en goede communicatie.&rdquo;</blockquote><figcaption class="rv-foot"><img class="rv-avatar" src="review-jeffrey.png" alt="Jeffrey" loading="lazy"><span class="rv-meta"><span class="rv-name">Jeffrey</span><span class="rv-company">Backbone Customer Service</span></span></figcaption></figure>
    <figure class="rv reveal"><div class="rv-deco">&ldquo;</div><svg class="rv-gmark" viewBox="0 0 24 24" aria-label="Google review"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.76h3.56c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.56-2.76c-.98.66-2.23 1.06-3.72 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84A11 11 0 0 0 12 23z"/><path fill="#FBBC05" d="M5.84 14.11a6.6 6.6 0 0 1 0-4.22V7.05H2.18a11 11 0 0 0 0 9.9l3.66-2.84z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.05l3.66 2.84C6.71 7.31 9.14 5.38 12 5.38z"/></svg><div class="rv-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><blockquote class="rv-q">&ldquo;Wat mij vooral opviel, is hoe snel Simon de kern van ons bedrijf wist te pakken. Een aanrader als je iemand zoekt die verder kijkt dan marketing en echt meedenkt over je groei.&rdquo;</blockquote><figcaption class="rv-foot"><img class="rv-avatar" src="review-bas.jpeg" alt="Bas" loading="lazy"><span class="rv-meta"><span class="rv-name">Bas</span><span class="rv-company">Volle Gym</span></span></figcaption></figure>
  </div>
</section>

<footer>
  <a href="https://www.pique.agency/dream-account-sprint" class="ft-cta">Meer weten over de Dream Account Sprint <svg viewBox="0 0 24 24"><path d="M5 12h14M13 6l6 6-6 6"/></svg></a>
...
const outDir = `/Users/simonkempers/Desktop/Pique - B2B Appointment Intelligence/Marketing/Outreach/Batch 5 - 22 juli - Franchise (75) + Enterprise (50)`;
